...
<table width="100%" cellspacing="0" cellpadding="0">
<tr><td height="2" bgcolor="#bbe1ea"></td></tr>
</table>
...
<tr> 
    <td width="4" height="28" bgcolor="#eef9fc"></td>
    <td width="50" align="center" bgcolor="#eef9fc"><span class="L_title">번호</span></td>
    <td width="10" align="center" bgcolor="#eef9fc"></td>
    <? if ($is_category) { ?><td width="70" align="center" bgcolor="#eef9fc"><span class="L_title">분류</span></td><? } ?>
    <? if ($is_checkbox) { ?><td width="40" align="center" bgcolor="#eef9fc"><INPUT onclick="if (this.checked) all_checked(true); else all_checked(false);" type=checkbox></td><? } ?>
    <td align="center" bgcolor="#eef9fc"><span class="L_title">제목</span></td>
    <td width="110" align="center" bgcolor="#eef9fc"><span class="L_title">글쓴이</span></td>
    <td width="40" align="center" bgcolor="#eef9fc"><?=subject_sort_link('wr_datetime', $qstr2, 1)?><span class="L_title">날짜</span></a></td>
    <td width="40" align="center" bgcolor="#eef9fc"><?=subject_sort_link('wr_hit', $qstr2, 1)?><span class="L_title">조회</span></a></td>
    <td width="4" bgcolor="#eef9fc"></td>
</tr>

<tr> 
    <td width="4" height="1" bgcolor="#bbe1ea"></td>
    <td width="50" bgcolor="#bbe1ea"></td>
    <td width="10" bgcolor="#bbe1ea"></td>
    <? if ($is_category) { ?><td width="70" bgcolor="#bbe1ea"></td><? } ?>
    <? if ($is_checkbox) { ?><td width="40" bgcolor="#bbe1ea"></td><? } ?>
    <td bgcolor="#bbe1ea"></td>
    <td width="110" bgcolor="#bbe1ea"></td>
    <td width="40" bgcolor="#bbe1ea"></td>
    <td width="40" bgcolor="#bbe1ea"></td>
    <td width="4" bgcolor="#bbe1ea"></td>
</tr>

<!-- 목록 -->
<? for ($i=0; $i<count($list); $i++) { ?>
<!-- <tr height="28" <? if ($list[$i][is_notice]) { echo "bgcolor='#F9FBFB'"; } else { echo " onmouseover=\"this.style.backgroundColor='#eef9fc';return true;\" onMouseOut=\"this.style.backgroundColor='';return true;\""; }?>>  -->
<tr height="28"> 
    <td width="4"></td>
