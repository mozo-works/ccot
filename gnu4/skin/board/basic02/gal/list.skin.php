...
<table width="100%" cellspacing="0" cellpadding="0">
<tr><td height="2" bgcolor="#7a6049"></td></tr>
</table>
...
<tr> 
    <td width="4" height="28" bgcolor="#ddd6d1"></td>
    <td width="50" align="center" bgcolor="#ddd6d1"><span class="L_title">번호</span></td>
    <td width="10" align="center" bgcolor="#ddd6d1"></td>
    <? if ($is_category) { ?><td width="70" align="center" bgcolor="#ddd6d1"><span class="L_title">분류</span></td><? } ?>
    <? if ($is_checkbox) { ?><td width="40" align="center" bgcolor="#ddd6d1"><INPUT onclick="if (this.checked) all_checked(true); else all_checked(false);" type=checkbox></td><? } ?>
    <td align="center" bgcolor="#ddd6d1"><span class="L_title">제목</span></td>
    <td width="110" align="center" bgcolor="#ddd6d1"><span class="L_title">글쓴이</span></td>
    <td width="40" align="center" bgcolor="#ddd6d1"><?=subject_sort_link('wr_datetime', $qstr2, 1)?><span class="L_title">날짜</span></a></td>
    <td width="40" align="center" bgcolor="#ddd6d1"><?=subject_sort_link('wr_hit', $qstr2, 1)?><span class="L_title">조회</span></a></td>
    <td width="4" bgcolor="#ddd6d1"></td>
</tr>

<tr> 
    <td width="4" height="1" bgcolor="#7a6049"></td>
    <td width="50" bgcolor="#7a6049"></td>
    <td width="10" bgcolor="#7a6049"></td>
    <? if ($is_category) { ?><td width="70" bgcolor="#7a6049"></td><? } ?>
    <? if ($is_checkbox) { ?><td width="40" bgcolor="#7a6049"></td><? } ?>
    <td bgcolor="#7a6049"></td>
    <td width="110" bgcolor="#7a6049"></td>
    <td width="40" bgcolor="#7a6049"></td>
    <td width="40" bgcolor="#7a6049"></td>
    <td width="4" bgcolor="#7a6049"></td>
</tr>

<!-- 목록 -->
<? for ($i=0; $i<count($list); $i++) { ?>
<!-- <tr height="28" <? if ($list[$i][is_notice]) { echo "bgcolor='#F9FBFB'"; } else { echo " onmouseover=\"this.style.backgroundColor='#ddd6d1';return true;\" onMouseOut=\"this.style.backgroundColor='';return true;\""; }?>>  -->
<tr height="28"> 
    <td width="4"></td>
