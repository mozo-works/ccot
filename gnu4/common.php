...
// include_path 지정
$g4_ab_path = $_SERVER['DOCUMENT_ROOT'].'/gnu4';
$lib_path = $g4_ab_path.'/lib';
$PEAR_path = $lib_path.'/_PEAR';
set_include_path(get_include_path() . PATH_SEPARATOR . $g4_ab_path. PATH_SEPARATOR .$lib_path. PATH_SEPARATOR .$PEAR_path);
