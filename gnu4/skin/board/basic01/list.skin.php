...
<tr>
    <? if ($is_category) { ?><form name="fcategory" method="get"><td width="50%"><select name=sca onchange="location='<?=$category_location?>'+this.value;"><option value=''>전체</option><?=$category_option?></select></td>
    </form><? } ?>
    <td align="right">
        <? if ($admin_href) { ?><a href="<?=$admin_href?>">게시물 <?=number_format($total_count)?>건</a><? } ?></td>
</tr>
</table>
...
<tr> 
    ...
    <td width="50" align="center" bgcolor="#FFFFFF" class="b_bg"><span class='b_tit'>번호</span></td>
    <? if ($is_category) { ?><td align="center" bgcolor="#FFFFFF" class="b_bg"><span class='b_tit'>분류</span></td>
    <? } ?>
    ...
    <td width='' align="center" bgcolor="#FFFFFF" class="b_bg"><span class='b_tit'>제목</span></td>
    <td width="90" align="center" bgcolor="#FFFFFF" class="b_bg" lign="center"><span class='b_tit'>글쓴이</span></td>
    <td width="40" align="center" bgcolor="#FFFFFF" class="b_bg"><?=subject_sort_link('wr_datetime', $qstr2, 1)?><span class='b_tit'>날짜</span></a></span></td>
    <td width="40" align="center" bgcolor="#FFFFFF" class="b_bg"><?=subject_sort_link('wr_hit', $qstr2, 1)?><span class='b_tit'>조회</span></a></td>
    <? if ($is_good) { ?>
	<td width="40" align="center" bgcolor="#FFFFFF" class="b_bg"><?=subject_sort_link('wr_good', $qstr2, 1)?><span class='b_tit'>추천</span></a></td>
	<? } ?>
    <? if ($is_nogood) { ?>
	<td width="40" align="center" bgcolor="#FFFFFF" class="b_bg"><?=subject_sort_link('wr_nogood', $qstr2, 1)?><span class='b_tit'>비추천</span></a></td>
	<? } ?>
</tr>
</table></td>
      </tr>
